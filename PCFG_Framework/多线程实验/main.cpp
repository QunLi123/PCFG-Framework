...
int main()
{
    ...
    // for(auto it:q.m.letters)
    // {
    //     if(it.length>letter_length)
    //     {
    //         letter_length=it.length;
    //     }
    // }
    // for(auto it:q.m.digits)
    // {
    //     if(it.length>digit_length)
    //     {
    //         digit_length=it.length;
    //     }
    // }
    // for(auto it:q.m.symbols)
    // {
    //     if(it.length>symbol_length)
    //     {
    //         symbol_length=it.length;
    //     }
    // }
    // cout << "letter_length:" << letter_length << endl;
    // cout << "digit_length:" << digit_length << endl;
    // cout << "symbol_length:" << symbol_length << endl;
    q.init();
    //
    q.init_permanent_threads(4);
    // q.setup_thread_pool(4);
    //
    cout << "here" << endl;
    int curr_num = 0;
    ...
    while (!q.priority.empty())
    {
        ...
        {
            cout << "Guesses generated2 " << history + q.total_guesses << endl;
