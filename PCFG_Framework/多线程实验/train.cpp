...
//哈希表效果并不好
// int model::FindLetter_Hash(segment seg) {
//     return letter_length_map[seg.length];
// }
//
// int model::FindDigit_Hash(segment seg) {
//     return digit_length_map[seg.length];
// }
//
// int model::FindSymbol_Hash(segment seg) {
//     return symbol_length_map[seg.length];
// }
// void model::build_segment_maps() {
//     letter_length_map.clear();
//     digit_length_map.clear();
//     symbol_length_map.clear();
//     for (int i = 0; i < letters.size(); i++) {
//         letter_length_map[letters[i].length] = i;
//     }
//     for (int i = 0; i < digits.size(); i++) {
//         digit_length_map[digits[i].length] = i;
//     }
//     for (int i = 0; i < symbols.size(); i++) {
//         symbol_length_map[symbols[i].length] = i;
//     }
// }
...
void model::build_maps()
{
    std::fill_n(letter_indices, 256, -1);
    std::fill_n(digit_indices, 256, -1);
    std::fill_n(symbol_indices, 256, -1);
    
    // 构建letters映射
    for (int i = 0; i < letters.size(); i++) {
        letter_indices[letters[i].length] = i;
    }
    
    // 构建digits映射
    for (int i = 0; i < digits.size(); i++) {
        digit_indices[digits[i].length] = i;
    }
    
    // 构建symbols映射
    for (int i = 0; i < symbols.size(); i++) {
        symbol_indices[symbols[i].length] = i;
    }
}
void model::order()
{
